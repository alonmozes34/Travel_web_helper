...
for (const path of ['/', '/esim/thailand', '/search?to=DE:1,US:14', '/devices', '/esim', '/car-rental?country=FR&pickup=Paris%20CDG']) {
...
for (const path of ['/', '/esim/thailand?days=14&usage=regular', '/search?to=DE:1,US:14&usage=regular', '/accessibility', '/disclosure', '/devices', '/en/devices', '/esim', '/en/esim', '/car-rental?country=FR&pickup=Paris%20CDG', '/en']) {
